"""
Django settings for test_drone_express_47490 project.
...
ROOT_URLCONF = 'test_drone_express_47490.urls'
...
WSGI_APPLICATION = 'test_drone_express_47490.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_drone_express_47490 API",
    "DESCRIPTION": "API documentation for test_drone_express_47490 App",
    "VERSION": "v1",
}
